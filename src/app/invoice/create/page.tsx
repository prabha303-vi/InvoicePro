...
export default function CreateInvoicePage() {
  ...
  const [formData, setFormData] = useState({
    companyName: "SRI SABARI HEAT SETTINGS",
    companyAddress: "8/1650, THIRUNAGAR EXTN., POOLUVAPATTI ROAD,",
    companyAddress2: "P.N ROAD, TIRUPUR 641 602",
    companyCell: "98421 31190, 9751331190",
    companyGSTIN: "33ADEFS0989B1Z7",
    companyPhone1: "9751331190",
    companyPhone2: "98421 31190",
    invoiceNumber: "771/25-26",
    invoiceDate: formatDate(new Date()),
    serviceCode: "998821",
    stateCode: "Tamilnadu & 33",
    customerName: "VIJAYAVENI KNITTERS",
    customerAddress: "23, Mullai Street, Lakshmi Nagar,",
    customerAddress2: "TIRUPUR-641602",
    customerGSTIN: "33APFPS4919C1Z0",
    bankName: "UNION BANK OF INDIA",
    bankBranch: "560-TIRUPUR",
    bankAcNo: "056011100003651",
    bankIFSC: "UBIN0805602",
    cgstRate: "2.50",
    sgstRate: "2.50",
    items: [
      {
